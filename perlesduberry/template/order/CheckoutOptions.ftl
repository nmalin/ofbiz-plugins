...
<form method="post" name="checkoutInfoForm">
  ...
  <input type="hidden" name="BACK_PAGE" value="quickcheckout"/>
        <div class="card">
          ...
          <div class="card-body" >
            ...
            <div class="btn-toolbar mb-2">
              <a href="javascript:submitForm(document.checkoutInfoForm, 'NA', '');" class="btn btn-outline-secondary mr-2">${uiLabelMap.PartyAddNewAddress}</a>
            </div>
                  ...
                  <div class="form-check">
                    ...
                    <label for="shipping_contact_mech_id">
                      ...
                      <#if shippingAddress.countryGeoId?has_content>
                          <#assign shippingCountry = shippingContactMech.getDelegator().findOne("Geo", true, "geoId", shippingAddress.countryGeoId)>
                          ${shippingCountry.geoName}
                      </#if>
                    </label>
                  </div>
                ...
                <#else>
                 ...
                 <#if shipping == true>
                  <#if productStore.showCheckoutGiftOptions! != "N" && giftEnable! != "N">
                      <div>
                        <h5>Souhaitez vous faire de cette envoi un cadeau pour l'un de vos proches ?</h5><#--
        ...
        <div class="card" >
            <h4 class="card-header">
              3.&nbsp;Paiement de votre commande ?
            </h4>
            <input type="hidden" id="checkOutEXT_OFFLINE" class="form-check-input" name="checkOutPaymentId" value="EXT_OFFLINE"/>
            <div class="card-body">
                <p>Notre site de vente en ligne étant très jeune nous n'avons à l'heure actuelle pour des raisons de simplicité que la possibilité de réaliser le paiement par virement bancaire.
                À l'issue de votre commande merci de réaliser un virement du montant de cette commande sur les coordonnées bancaire de <b>Perles du berry</b> ...</p>
                <p>Afin de simplifier l'identification de votre paiement, indiqué bien votre numéro de commande dans la description de votre virement.</p>

                <p>Si vous n'avez pas de quoi noter ne paniquez pas on vous envoie le détail dans votre mail de coonfirmation de commande.</p>
            </div>
        </div>
